              ...
              <div className="mt-10 mb-6">
                ...
                <div className="md:hidden grid grid-cols-2 gap-4">
                  {displayedTopStores.map(store => (
                    <div key={`top-mobile-${store.id}`} className="transition-all duration-300 hover:translate-y-[-5px]">
                ...
                <div className="hidden md:grid md:grid-cols-4 gap-6">
                  {topStores.map(store => (
                    <div key={`top-desktop-${store.id}`} className="transition-all duration-300 hover:translate-y-[-5px]">
                      <StoreCard store={store} />
                    </div>
                  ))}
                </div>
